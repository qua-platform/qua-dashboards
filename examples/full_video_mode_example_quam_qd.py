...
from quam_builder.architecture.quantum_dots.components import VoltageGate, VirtualGateSet, ReadoutResonatorSingle
...
def setup_readout_channel(name: str, readout_pulse: pulses.ReadoutPulse, opx_output_port: int, opx_input_port: int, IF: float, con = "con1", fem: int = None):
    """
...
def main():
    ...
    sensor_readout_channel_1 = setup_readout_channel(name = "readout_resonator_1", readout_pulse=readout_pulse_ch1, opx_output_port = 6, opx_input_port = 1, IF = 150e6, fem = fem)
    sensor_readout_channel_2 = setup_readout_channel(name = "readout_resonator_2", readout_pulse=readout_pulse_ch2, opx_output_port = 6, opx_input_port = 1, IF = 250e6, fem = fem)
    ...
    data_acquirer = OPXDataAcquirer(
        qmm=qmm,
        machine=machine,
        gate_set=machine.virtual_gate_sets["main_qpu"],  # Replace with your GateSet instance
