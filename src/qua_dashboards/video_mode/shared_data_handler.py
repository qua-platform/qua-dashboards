...
class SharedDataHandler:
    ...
    def _make_readout_subplots_with_profile(
        self, da: xr.DataArray, profile: dict
    ) -> go.Figure:
        """
    ...
    def _axis_vals_and_label(
        self, da: xr.DataArray, dim: str
    ...
    def _make_readout_subplots(self, da: xr.DataArray) -> go.Figure:
        ...
        fig = make_subplots(
            ...
            cols=n,
            subplot_titles=labels,
            horizontal_spacing=self._safe_hspace(n),
        )
        yc, xc = da.coords[y_name], da.coords[x_name]
        y_title = (
    ...
    def _resolve_profile_col(
        self, da: xr.DataArray | None, profile: dict | None
    ) -> int | None:
